...
come up with those around you.
- Try to come up with a list of at least five things that
strike you as either similar to or different from Python.  
  (Answer: 1. can define boolean and set value in one continuous line;  2. System class for println)
...
the file. Then click the commit button to commit the change to the repository. [made change, september 11 2024]
